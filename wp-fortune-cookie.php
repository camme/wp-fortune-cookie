...
Description: Creates a fortune cookie every 24 hours in the users browser
Author: Camilo Tapia @ onezerozeroone.com
Author URI: onezerozeroone.com
*/

add_action('init', 'fortune_cookie');

if (!function_exists('fortune_cookie')) {
    
    function fortune_cookie($what) {
    	...
    	if (!isset($_COOKIE['Fortune-cookie'])) {
    	    $cookieContent = $allCookies[rand(0, sizeof($allCookies) - 1)];
    		setcookie('Fortune-cookie', $cookieContent, time()+3600*24);
    	}
